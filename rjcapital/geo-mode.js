// ═══════════════════════════════════════════════════════════════════════════
// GEO-MODE.JS  —  Modo Geográfico  •  Rio de Janeiro (Capital)-RJ
//
...
window.GeoMode = (function () {
  ...
  let _filtroAtivo   = null   // bairro/zona filtrado pelo dropdown
  ...
  // ── Filtrar bairro/zona (chamado quando repaintMapa delega) ─────────────
  ...
  async function refreshPins() {
    ...
    try {
      ...
      if (!token) return
      const r = await fetch(`${window.API_URL}/liderancas/geo?mapa=rjcapital`, {
  ...
  async function ativar() {
    ...
    if (!_geojsonCache) {
      try {
        const r = await fetch('geo/riobairros.geojson')
    ...
    _selectedLayer = window._rjLayerSelecionado || null
    syncStyles()
    ...
    console.log('[GeoMode] Modo Geográfico ativado (Rio de Janeiro Capital)')
  }
  ...
  function desativar() {
    ...
    console.log('[GeoMode] Modo Estratégico restaurado (Rio de Janeiro Capital)')
  }
