const distritos = {
  ...
  "3º DISTRITO": {
    ...
    bairros: ["MOMBAÇA", "CIDADE DA BÍBLIA", "CAMORIM", "CAMORIM PEQUENO", "CANTAGALO", "PONTA LESTE", "PARAÍSO", "ÁGUA SANTA", "LAMBICADA", "PRAIA DO MACHADO", "JACUACANGA/VILAGGE/BNH", "JACUAGANGA", "ÁGUA SANTA/VILA PETROBRAS", "CAPUTERA I", "CAPUTERA II", "MONSUABA", "PORTOGALO", "PONTALESTE/PARA/BISCAIA/MACI", "VILA DA PETROBRÁS", "VILA DOS PESCADORES", "VILLAGE JACUACANGA", "TERMINAL DA PETROBRÁS", "BISCAIA", "CAETÉS", "GARATUCAIA", "MORRO DO MORENO", "MACIÉIS"]
  },
