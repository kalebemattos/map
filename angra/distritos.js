const distritos = {
  "1º DISTRITO": {
    ...
    bairros: [
      ...
      "MONTE CASTELO", "SAPINHATUBA I", "SAPINHATUBA II", "SAPINHATUBA III",
  ...
  "2º DISTRITO": {
    ...
    bairros: [
      ...
      "ENSEADA", "GAMBOA DO BELÉM", "JAPUÍBA", "NOVA ANGRA",
      "PARQUE BELÉM", "PONTA DA RIBEIRA", "PONTA DO SAPÊ", "PONTA DOS UBÁS",
      "PRAIA DA RIBEIRA", "RETIRO", "VILA NOVA"
    ]
  },
  ...
  "3º DISTRITO": {
    ...
    bairros: [
      ...
      "GARATUCAIA", "JACUACANGA", "JACUECANGA", "LAMBICADA", "MACIÉIS", "MOMBAÇA",
